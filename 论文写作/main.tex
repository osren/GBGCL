...
GBGCL extends SGRL with granular-ball diffusion and BTCM, which injects diffused ball embeddings into both encoders through BallConv message passing.
Experiments on four benchmarks show consistent gains over SGRL, while ablations and training-dynamics analysis attribute the improvement to encoder-level ball injection rather than parallel write-back alone.
